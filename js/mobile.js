define([], function(){
	...
	var renderDOM = function(){
		...
		var tagStr = $tag?'<span class="viewer-title">分類</span><div class="viewer-div tagcloud" id="js-mobile-tagcloud"></div>':"";
		var friendsStr = $friends?'<span class="viewer-title">學習平台</span><div class="viewer-div friends" id="js-mobile-friends"></div>':"";
